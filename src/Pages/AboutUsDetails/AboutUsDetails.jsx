        ...
        <div>
            <div className="container mx-auto mt-12 mb-24">
                <div className="flex items-center gap-4">
                    ...
                    <img data-aos="zoom-in-left" className="w-1/2 lg:h-[512px] rounded-2xl" src="https://i.postimg.cc/nLPn06br/graphics-design.jpg" alt="" />
                </div>
                <div className="flex items-center gap-4">
                    <img data-aos="zoom-in-right" className="w-1/2 lg:h-[512px] rounded-2xl" src="https://i.postimg.cc/bYS7jZbm/about3.jpg" alt="" />
                ...
                <div className="flex items-center gap-4">
                    <p className="text-lg">With a focus on simplicity, transparency, and community, we offer a modern and
                        ...
                        and industries.</p>
                    <img data-aos="zoom-in-left" className="w-1/2 lg:h-[512px] rounded-2xl" src="https://i.postimg.cc/Y0wj71TB/banner2.jpg" alt="" />
                </div>
                <div className="flex items-center gap-4">
                    <img data-aos="zoom-in-right" className="w-1/2 lg:h-[512px] rounded-2xl" src="https://i.postimg.cc/65sD6Bft/about2.jpg" alt="" />
