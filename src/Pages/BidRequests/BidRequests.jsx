...
const BidRequests = () => {
    ...
    const { mutateAsync }= useMutation({
        ...
        onSuccess: ()=>{
            ...
            // refresh the UI for latest data of this page
            // refetch()

            // refresh the UI for latest data of the entire application
    ...
    const handleStatus = async(id, prevStatus, status) => {
        if (prevStatus === status) {
            return toast.error("cannot update same data twice!", {
                position: "top-center"
            });
        }
                                                    ...
                                                    <div className='flex items-center gap-x-2'>
                                                        <p
                                                            className={`px-3 py-1 ${bid.category === 'Web Development' && 'text-blue-500 bg-blue-100/60'
                                                                } ${bid.category === 'Digital Marketing' && 'text-emerald-500 bg-emerald-100/60'
                                                                } ${bid.category === 'Graphics Design' && 'text-pink-500 bg-pink-100/60'
